...
describe("Test Personal Data input when using checkout", () => {
  ...
  it("Input first name only", () => {
    cy.typeFirstName();
    cy.clickContinue();
    cy.checkErrorMessageLastName("h3", "Error: Last Name is required");
  });

  it("Input last name only", () => {
    cy.typeLastName();
    cy.clickContinue();
    cy.checkErrorMessageFirstName("h3", "First Name is required");
  });
  ...
  it("Input first name and last name", () => {
    ...
    cy.typeLastName();
    cy.clickContinue();
    cy.checkErrorMessagePostalCode("h3", "Error: Postal Code is required");
  });
